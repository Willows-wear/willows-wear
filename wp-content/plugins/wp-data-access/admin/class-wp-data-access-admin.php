...
class WP_Data_Access_Admin
{
    ...
    public function enqueue_styles()
    {
        ...
        // Register JQuery DataTables to test data tables in the dashboard.
        wp_register_style(
            'jquery_datatables',
        ...
        // Register JQuery DataTables Responsive to test data tables in the dashboard.
        wp_register_style(
    ...
    public function enqueue_scripts()
    {
        ...
        // Ajax call to WPDA datables implementation to test data tables in the dashboard.
        wp_register_script(
            'wpda_datatables',
