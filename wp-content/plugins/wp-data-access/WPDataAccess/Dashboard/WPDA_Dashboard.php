				...
				<div class="wpda-nowrap">
					<div>
						<div>
							...
							<i class="fas fa-code wpda_tooltip" title="Import table designs" onclick="jQuery('#upload_file_container').show()"></i>
							<br/>
        ...
        ?>">
			...
			<div id="wpda-dashboard-toolbar" class="wpda-dashboard-toolbar" style="display:none">
				<div class="wpda-nowrap">
					<div>
						<div>
							<i id="wpda_toolbar_icon_add_publication" class="fas fa-plus-circle wpda_tooltip" title="Create new data table"></i>
							<br/>
							Create data table
						</div><div>
							<i class="fas fa-code wpda_tooltip" title="Import data tables" onclick="jQuery('#upload_file_container').show()"></i>
							<br/>
							Import data tables
						</div><?php 
        ?>
				...
				<div class="wpda-nowrap">
					<div>
						<div>
							...
							<i class="fas fa-code wpda_tooltip" title="Import projects" onclick="jQuery('#upload_file_container_multi').show()"></i>
							<br/>
							Import projects
						</div>
					</div>
